...
class ApiWeek extends StatefulWidget {
  const ApiWeek({Key key}) : super(key: key);

  @override
  State<ApiWeek> createState() => _ApiWeekState();
}

class _ApiWeekState extends State<ApiWeek> {
    var users = [];
    getUser() async { 
    http.Response response;
    response = await http
        .get(Uri.parse("https://magentix.ch/api/get_order/week"));
