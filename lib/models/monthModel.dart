...
class ApiMonth extends StatefulWidget {
  const ApiMonth({Key key}) : super(key: key);

  @override
  State<ApiMonth> createState() => _ApiMonthState();
}

class _ApiMonthState extends State<ApiMonth> {   
    var users = [];
    getUser() async { 
    http.Response response;
    response = await http
        .get(Uri.parse("https://magentix.ch/api/get_order/month"));
